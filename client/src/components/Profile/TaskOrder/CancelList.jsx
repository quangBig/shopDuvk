...
const CancelList = () => {
    ...
    // Lọc đơn hàng bị hủy trước khi phân trang
    const filteredOrders = orders.filter(order => order.orderStatus === "Đơn hàng hủy");
    ...
    return (
        <div className="bg-white shadow-md rounded-lg p-4 max-w-full mx-auto">
            ...
            <h2 className="text-xl font-semibold mb-4 text-gray-700">Đơn hàng đã hủy</h2>
                        ...
                        <div key={order._id} className="border rounded-lg p-4 shadow-md mb-4">
                            <div className="flex justify-between items-center pb-2">
                                <div>
                                    ...
                                    <p className="text-gray-700">Ngày hủy: {new Date(order.createdAt).toLocaleString()}</p>
                                </div>
                            ...
                            <div className="mt-4 pt-4 flex justify-between items-center">
                                ...
                                <div className="flex space-x-3">
                                    ...
                                    <button className="border border-gray-400 text-gray-600 px-4 py-2 rounded hover:bg-gray-100">
                                        Liên Hệ Người Bán
                                    </button>
                                </div>
                            </div>
