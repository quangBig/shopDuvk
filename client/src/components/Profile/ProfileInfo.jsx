...
const ProfileInfo = () => {
    ...
    return (
        <div className="bg-white shadow-md rounded-lg p-6 max-w-lg mx-auto">
            ...
            {/* Avatar & Thông tin */}
            <div className="flex flex-col items-center md:flex-row md:items-center md:gap-6 border rounded-lg p-5 shadow-md">
                {/* Ảnh đại diện */}
                {user?.avatar ? (
                    <img
                        src={user.avatar}
                    ...
                    <FaRegUserCircle className="text-gray-400 text-6xl" />
                )}
                ...
                <div className="text-center md:text-left space-y-2 mt-3 md:mt-0">
                    ...
                    <div className="flex flex-col md:flex-row gap-2">
                        ...
                        <p className="font-semibold">{user?.email || "Chưa cập nhật"}</p>
                    </div>
                </div>
            </div>
        </div>
